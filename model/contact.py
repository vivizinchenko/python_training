...
class Contact:
    ...
    def __eq__(self, other):
        return (self.id is None or other.id is None or self.id == other.id or self.firstname is None or
                other.firstname is None or self.lastname is None or other.lastname is None) and \
